...
public class ExchangeService {
    ...
    public ExchangeRate findById(long id){
        Optional<ExchangeRate> optional = exchangeRepo.findById(id);
    ...
    public ExchangeRate findByDateFrom(String from){
        ...
        return exchangeRepo.findByDate(dateFrom).orElse(findById(1L));
    }
    ...
    public ExchangeRate findByDateFromTo(String from, String to){
        ...
        List<ExchangeRate> exchangeRates = exchangeRepo.findByDate(dateFrom, dateTo);
